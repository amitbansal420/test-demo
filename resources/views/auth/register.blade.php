                ...
                <div class="card-body">
                    ...
                    <form enctype="multipart/form-data"  id="formData" onsubmit="return false">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="contact" type="text" class="form-control" name="contact" required autocomplete="" onkeypress="return isNumber(event)">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="file" type="file" class="form-control" name="image" required autocomplete="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="father_name" type="text" class="form-control" name="father_name" required autocomplete="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mother_name" type="text" class="form-control" name="mother_name" required autocomplete="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="wife" type="text" class="form-control" name="wife" required autocomplete="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="child" type="text" class="form-control" name="child" required autocomplete="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="country" type="text" class="form-control" name="country" required autocomplete="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="city" type="text" class="form-control" name="city" required autocomplete="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="state" type="text" class="form-control" name="state" required autocomplete="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="zipcode" type="text" class="form-control" name="zipcode" required autocomplete="">
                            </div>
                        </div>
